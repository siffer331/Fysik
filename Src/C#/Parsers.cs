...
public static class Parsers {
    ...
    public static PS.ParserRes calculation(String s) {
        Parser basicElement = PS.Choice(num, PS.SetType(parenthesis(calculation), "calculation"));
        Parser element = PS.Choice(basicElement, PS.SetType(PS.Sequence(PS.Str("-"), basicElement), "negate"));
	...
	public static Parser unitMultiply = PS.SetType(PS.ManySeperated(PS.Str("*"), unitPart), "unit_multiply");
